    ...
    hooks
      ...
      .catch(error => {
        req.io.emit("notification", {
          title: "Whoops",
          message: `We couldn't get plugins list`,
          type: "error"
        });
  ...
  getPlugin: (req, res) => {
    hooks
      ...
      .catch(error => {
        req.io.emit("notification", {
          title: "Whoops",
          message: `We couldn't get the plugin`,
          type: "error"
        });
  ...
  updateSettings: (req, res) => {
    hooks
      ...
      .catch(error => {
        req.io.emit("notification", {
          title: "Whoops",
          message: `Error adding settings to plugin`,
          type: "error"
        });

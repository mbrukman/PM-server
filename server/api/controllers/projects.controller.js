...
module.exports = {
  ...
  filter: (req, res) => {
    hooks
      ...
      .catch(error => {
        req.io.emit("notification", {
          title: "Whoops..",
          message: `Error getting projects list`,
          type: "error"
        });
  ...
  filterRecentMaps: (req, res) => {
    hooks
      .hookPre("project-filter-maps", req)
      .then(() => {
      ...
      .catch(error => {
        req.io.emit("notification", {
          title: "Whoops..",
          message: `Error getting recent maps`,
          type: "error"
        });

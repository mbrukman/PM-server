...
*/
  ...
  getRelevantAgent(groups, mapAgents) {
    function filterLiveAgents(agents) {
      const agentsStatus = Object.assign({}, agentsService.agentsStatus());
      const allAgents = [];
    ...
    const totalAgents = [...JSON.parse(JSON.stringify(mapAgents)), ...JSON.parse(JSON.stringify(groupsAgents))];
